                ...
                <div className='home-header-container'>
                    <div className='home-header-content'>
                        <div className='left-content'>
                            <img className='logo' src={logo1} onClick={() => this.retrunToHome()} />
                    ...
                    <div className='home-header-banner'>
                        ...
                        <div className='content-down'>
                            <div className='options'>
                                ...
                                <div className='options-child'>
                                    <div className='icon-child'><i className="fa fa-ambulance"></i></div>
                                    <div className='text-child'><FormattedMessage id="banner.child8" /></div>
                                </div>
                                <div className='options-child'>
                                    <div className='icon-child'><i className="fa fa-h-square"></i></div>
