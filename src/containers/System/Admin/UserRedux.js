...
import 'react-image-lightbox/style.css'// css của thư viện 
...
class UserRedux extends Component {
    ...
    async componentDidMount() {
        ...
        // this.props.dispatch(actions.getGenderStart()) //cách viết 2, cú pháp chuẩn
        // try {
    ...
    handleSaveUser = () => {
        ...
        let { action } = this.state // bằng với let action = this.state.action
    ...
    render() {
        ...
        //cách đặt object nhìu 
        let { email, password, firstName, lastName, phoneNumber, address, gender, position, role, avatar } = this.state

        return (
            <div className='user-redux-container'>
                <div className='title'>
                    User redux with Nguyễn Đạt
                </div>
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        // procesLogout: () => dispatch(actions.processLogout()),
